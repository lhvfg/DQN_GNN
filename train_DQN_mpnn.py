...
import os
import random
from ES import mpnn as gnn
import tensorflow as tf
from collections import deque
from util.utils import save_throughput
from configs.DQN import *
...
if __name__ == "__main__":
    ...
    for ep_it in range(ITERATIONS):
        ...
        if ep_it % evaluation_interval == 0:
            ...
            evalMeanReward = np.mean(rewards_test)
            save_throughput('DQN_GNN-' + str(graph_topology), ep_it, evalMeanReward, demandlist, min_utilization,
                          mean_utilization)
